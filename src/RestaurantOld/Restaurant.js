...
const RestaurantInfo = {
    ...
    "restaurantbio":"Bustling taqueria serving tacos, quesadillas & aguas frescas in a street style set max 99 characters"
}
               ...
               <div className="container" style={setNewCHeight}>
                  ...
                  <header className="js-header" style={{"border":"1px dashed blue"}}>
                    <div className="rest-info-container">
                       <div className="rest-info" style={setNewWidth}>
                        <h2> {this.state.restaurant.name}</h2>
                        <h4 className="restaurantbio"> {this.truncate(this.state.restaurant.restaurantbio)}</h4>
                          <div className="rest-info-flex-grow"></div>
                          <div className="rest-info-contact-container">
                             <Logo href={this.state.restaurant.contact} src={contact} alt="Contact Button"/>
                             <Logo href={this.state.restaurant.location} src={location} alt="Location Button" style={{"padding-left": "1.5em"}}/>
                          </div>
                       </div>
                       <div style={setNewImageWidth} className="rest-image-container">
                        <Image src={"https://cdn.pixabay.com/photo/2015/09/14/11/43/restaurant-939434_960_720.jpg"} className="rest-image"/>
                       </div>
                    </div>
                  </header>
